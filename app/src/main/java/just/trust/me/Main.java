...
public class Main implements IXposedHookLoadPackage {
    ...
    void processOkHttp(ClassLoader classLoader) {
        ...
        Log.d(TAG, "Hooking c.g.d(String,List) (3.x) for: " + currentPackageName);

        try {
            classLoader.loadClass("c.g");
            findAndHookMethod("c.g",
                    classLoader,
                    "d",
                    String.class,
                    List.class,
            ...
            Log.d(TAG, "OKHTTP 3.x not found in " + currentPackageName + " -- not hooking c.g.d");
            // pass
        }

        Log.d(TAG, "Hooking c.g.d(String,List) (3.x) --check for: " + currentPackageName);
        ...
        Log.d(TAG, "Hooking com.squareup.a.g.b(String,List) --check (3.x) for: " + currentPackageName);

        try {
            classLoader.loadClass("com.squareup.a.g");
            findAndHookMethod("com.squareup.a.g",
                    classLoader,
                    "b",
                    String.class,
                    List.class,
            ...
            Log.d(TAG, "OKHTTP 3.x not found in " + currentPackageName + " -- not hooking com.squareup.a.g.b");
            // pass
        }

        //https://github.com/square/okhttp/blob/parent-3.0.1/okhttp/src/main/java/okhttp3/internal/tls/OkHostnameVerifier.java
        try {
            classLoader.loadClass("c.a.i.d");
            findAndHookMethod("c.a.i.d",
                    classLoader,
                    "verify",
                    String.class,
            ...
            Log.d(TAG, "OKHTTP 3.x not found in " + currentPackageName + " -- not hooking OkHostnameVerifier.verify(String, SSLSession) c.a.i.d.verify");
            // pass
        }
